<template>
    <div class="bg-primary w-full p-8 pt-20 pb-20 flex">
        <div class="flex gap-6 font-pepe text-xl" style="margin:0 auto;align-items: center;">
        <RouterLink to="/#top"><img src="../../logo.png" class="nav-logo inline"></RouterLink>
        ...
        <a href="">Twitter</a>
        <a href="">Discord</a>
        <a href=""><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" class="w-4 h-4 inline">
 ...
 Music on</a>
        <audio autoplay loop source src="../../br1.wav" type="audio/mpeg"></audio>     
        </div>  
    </div>
</template>
